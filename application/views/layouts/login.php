...
<body class="bg-[#e6f1e9] min-h-screen flex items-center justify-center p-4">
	<main class="max-w-6xl w-full bg-white rounded-[40px] flex flex-col md:flex-row overflow-hidden shadow-lg">
		<!-- Left side -->
		<section class="flex flex-col justify-between p-8 md:p-10 w-full md:w-1/2 rounded-t-[40px] md:rounded-tl-[40px] md:rounded-bl-[40px]">
			<div>
				<div class="flex justify-between items-center mb-12">
					...
					<div class="flex items-center space-x-1 text-xs text-gray-700 font-semibold select-none">
						<img alt="French Flag" class="inline-block" height="15" src="https://flagcdn.com/w20/fr.png" width="20" />
						<span>Fr</span>
				...
				<form class="space-y-4 max-w-[320px]">
					<input class="w-full rounded-lg bg-[#f7f8fa] border border-transparent focus:border-[#3a7a3a] focus:ring-1 focus:ring-[#3a7a3a] text-xs text-gray-700 px-4 py-3 placeholder:text-gray-400 outline-none" placeholder="Your email address" required type="email" />
					<input class="w-full rounded-lg bg-[#f7f8fa] border border-transparent focus:border-[#3a7a3a] focus:ring-1 focus:ring-[#3a7a3a] text-xs text-gray-700 px-4 py-3 placeholder:text-gray-400 outline-none" placeholder="Your password" required type="password" />
					<a class="text-[10px] text-[#3a7a3a] font-semibold hover:underline inline-block" href="#">
						Forgot password?
					</a>
					<button class="w-full bg-black text-white text-[10px] font-semibold rounded-lg py-3 mt-4" type="submit">
						Next Step
					</button>
				</form>
			</div>
		...
		<section class="relative w-full md:w-1/2 flex items-center justify-center bg-[#d9d9d9]">
			<img alt="Green plant in wooden pots on white table with gray background" class="object-cover w-full h-full rounded-tr-[40px] rounded-br-[40px]" height="600" src="https://storage.googleapis.com/a1aa/image/dd557fe9-8066-487b-3de9-0a883d995474.jpg" width="600" />
			<div class="absolute bg-white bg-opacity-30 backdrop-blur-md rounded-xl p-6 max-w-[320px] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
				...
				<p class="text-white text-xs leading-tight">
					Laporan interaktif mencakup informasi terbaru tentang perawatan yang disetujui atau sedang diuji untuk setiap pasien / The interactive report includes updated information about approved or investigational treatments for each patient.
				</p>
			</div>
		</section>
	</main>
