...
<head>
	...
	<title>Surat Ijin Khajatan</title>
	<style>
		@page {
			size: A4;
			margin: 2cm;
...
<body>
	<div class="header">
		<img src="https://storage.googleapis.com/a1aa/image/eb240ec7-1618-4000-3494-0460c7767609.jpg" class="logo"
	...
	<h3 class="judul-surat">SURAT IJIN KHAJATAN</h3>

	<p class="nomor-surat">Nomor : <?= $pengajuan['no_pengajuan'] ?? '...' ?></p>

	<p class="no-indent">
		Membaca surat Permohonan ijin untuk Khajatan dari:
	</p>
	...
	<p class="no-indent">
		Mengijinkan: Kepada Sdr. <?= $pengajuan['nama_lengkap'] ?? '...' ?> pekerjaan dan alamat seperti tersebut di
		atas untuk mengadakan <?= $pengajuan['jenis_hajatan'] ?? 'Khajatan' ?> pada:
	</p>

	<table class="data-table">
		<tr>
			<td>Hari</td>
			<td>: <?= $pengajuan['hari_acara'] ?? '...' ?></td>
		</tr>
		<tr>
			<td>Tanggal</td>
			<td>: <?= $pengajuan['tanggal_acara'] ?? '...' ?></td>
		</tr>
	</table>

	<p>
		Demikian Surat Ijin Khajatan ini dibuat untuk dapat dipergunakan seperlunya.
	</p>
