<aside id="sidebar"
	...
	<div class="p-4 border-t border-green-600 flex-shrink-0">
		<div class="flex items-center">
			...
			<div class="ml-3">
				<p class="text-sm font-medium">Budi</p>
				<p class="text-xs text-green-200">Masyarakat Lampung</p>
			</div>
		</div>
		<a href="#" class="flex items-center mt-3 p-2 text-sm rounded-lg hover:bg-green-600">
			<svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
				<path fill-rule="evenodd"
